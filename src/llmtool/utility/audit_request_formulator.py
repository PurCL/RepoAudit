...
class AuditRequestFormulatorOutput(LLMToolOutput):
    ...
    def __str__(self):
        if isinstance(self.scope, AuditRequestFormulatorOutput.FileScope) or \
            isinstance(self.scope, AuditRequestFormulatorOutput.DirectoryScope) or \
            isinstance(self.scope, AuditRequestFormulatorOutput.RepoScope):
...
class AuditRequestFormulator(LLMTool):
    ...
    def _get_prompt(self, audit_request_formulator_input: AuditRequestFormulatorInput) -> str:
        ...
        prompt = prompt.replace("<DESCRIPTION>", audit_request_formulator_input.user_prompt_str)
        return prompt

    def _parse_response(self, response: str, audit_request_formulator_input: AuditRequestFormulatorInput) -> AuditRequestFormulatorOutput:
        """
